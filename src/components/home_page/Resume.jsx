                            ...
                            {activeTab === 2 && (
                                <div className='flex flex-col gap-10'>
                                    ...
                                    <div className='grid grid-col-2 gap-x-4 gap-y-5'>
                                        <div class="aos-init py-7 px-8 group rounded-lg bg-zinc-100 hover:bg-white hover:shadow-[0px_36px_100px_0px_rgba(8,_8,_8,_0.15);] aos-animate" data-aos="fade-up" data-aos-delay="900">
                                            <div class="flex flex-col gap-8">
                                                <div class="size-12 bg-white group-hover:bg-zinc-100 rounded-full flex justify-center items-center shadow text-2xl">
                                                    <i class="bi bi-phone"></i>
                                                </div>
                                                <div class="flex justify-between items-end gap-3">
                                                    <div class="text-xl font-bold group-hover:text-orange-400">Website Design</div>
                                                    <span class="group-hover:animate-moveUp group-hover:text-orange-400">
