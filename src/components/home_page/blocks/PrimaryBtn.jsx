...
const PrimaryBtn = ({ label }) => {
    return (
        <>
            <button type="button" className="px-6 justify-center group py-3.5 text-base font-bold text-[15px] flex items-center gap-2 text-white bg-black hover:bg-transparent border hover:text-black duration-300 border-black focus:ring-0 focus:outline-none rounded-lg text-center">
                <span>{label}</span>
