    ...
    return (
        <>
            <section className='py-20 lg:py-24 bg-orange-100 px-5 md:px-10 xl:px-12'>
                <div className='2xl:max-w-[1295px] lg:max-w-[1200px] mx-auto flex flex-col gap-18'>
                    {/* HEADING */}
                    ...
                    <div className="grid grid-cols-2 gap-5">
                        <div className='flex flex-col gap-4'>
                            ...
                            <div className='w-full flex justify-between gap-3 group duration-300'>
                                <div className='capitalize text-[32px] font-bold'>Moodboard App</div>
